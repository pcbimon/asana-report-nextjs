...
const ExportButtons: React.FC<ExportButtonsProps> = ({
  ...
  const generateCSVData = (data: Subtask[]): string => {
    ...
    data.forEach((subtask) => {
      const createdDate = subtask.created_at
        ? new Date(subtask.created_at).toLocaleDateString("th-TH")
        : "";
      const completedDate = subtask.completed_at
        ? new Date(subtask.completed_at).toLocaleDateString("th-TH")
        : "";
        ...
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
          <div style="text-align: center; margin-bottom: 30px; border-bottom: 2px solid #3b82f6; padding-bottom: 20px;">
            ...
            <p style="color: #6b7280; margin: 10px 0 0 0; font-size: 16px;">
              ${
                assigneeName ? `ของ ${assigneeName}` : "รายงานทั่วไป"
          ...
          <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; margin-bottom: 30px;">
            ...
            <div style="background: #fef2f2; padding: 20px; border-radius: 8px; text-align: center; border: 1px solid #fecaca;">
              <div style="font-size: 32px; font-weight: bold; color: #dc2626; margin-bottom: 8px;">${
                assigneeStats.overdueTasks
              }</div>
              <div style="color: #6b7280; font-size: 14px;">เลยกำหนด</div>
            </div>
            <div style="background: #f8fafc; padding: 20px; border-radius: 8px; text-align: center; border: 1px solid #e5e7eb;">
              <div style="font-size: 32px; font-weight: bold; color: #7c3aed; margin-bottom: 8px;">${Math.round(
                assigneeStats.completionRate
              )}%</div>
                ...
                ${
                  ...
                  <tr>
                    <td colspan="5" style="padding: 15px; text-align: center; color: #6b7280; border: 1px solid #e5e7eb;">
                      ... และอีก ${
                        subtasks.length - 50
                      } รายการ (ดูรายละเอียดเพิ่มเติมในไฟล์ Excel)
                    </td>
                  </tr>
                `
                    : ""
